<button {{ $attributes->merge(['type' => 'submit', 'class' => 'inline-flex items-center px-4 py-2 bg-primary-800
    ...
    uppercase tracking-widest hover:bg-primary-700 dark:hover:bg-white focus:bg-primary-700 dark:focus:bg-white
    active:bg-primary-900 dark:active:bg-primary-300 focus:outline-none focus:ring-2 focus:ring-indigo-500
