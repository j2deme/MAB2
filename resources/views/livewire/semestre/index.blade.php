  ...
  <div class="max-w-full mx-auto space-y-6 sm:px-6 lg:px-8">
    <div class="p-4 bg-white shadow sm:p-8 sm:rounded-lg">
      <div class="w-full">
        ...
        <div class="flow-root mt-4" id="semestres-wrapper">
          <div id="semestres-spinner" class="p-6 flex items-center justify-center bg-white border rounded">
          ...
          <script>
            (function () {
              window.addEventListener('semestres-table-mounted', function () {
                var s = document.getElementById('semestres-spinner');
